...
import SalesContent from "@/pages/admin/reports/CekKelayakanTA"; // Import Sales Content
import TrafficContent from "@/pages/admin/reports/PelaksanaanSeminar"; // Import Traffic Content
